...
import { CreateNewDisputeComponentComponent } from '../../dashboard/create-new-dispute-component/create-new-dispute-component.component';
...
export class BookingComponent implements OnInit {
  ...
  public listBookings:any;
    ...
    public openDispute() {
      console.log('Open Dispute Called');
